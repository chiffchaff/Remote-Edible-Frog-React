...
import './codat-fetch-progress-51.css'

const CodatFetchProgress51 = (props) => {
  return (
    <div className="codat-fetch-progress51-container">
      <Helmet>
        <title>Codat-FetchProgress-51 - Remote Edible Frog</title>
        <meta
          property="og:title"
          content="Codat-FetchProgress-51 - Remote Edible Frog"
        />
        <meta
          property="og:image"
...
export default CodatFetchProgress51
